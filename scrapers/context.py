...
class ScraperContext(Protocol):
    ...
    def find_element_safe(self, selector: str, required: bool = True, timeout: int | None = None) -> Any: ...

    def find_elements_safe(self, selector: str, timeout: int | None = None) -> list[Any]: ...

    def extract_value_from_element(self, element: Any, attribute: str | None = None) -> Any: ...
